...
<div class="mb-10 border-b-4 border-black pb-4 flex justify-between items-end">
    <h2 class="text-4xl font-black uppercase tracking-tight">Kategori</h2>
        ...
        <div class="border-4 border-black bg-white shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
            <div class="overflow-x-auto p-6">
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr>
                            <th class="border-b-4 border-black pb-4 text-sm font-bold uppercase tracking-widest">Nama</th>
                            <th class="border-b-4 border-black pb-4 text-sm font-bold uppercase tracking-widest">Deskripsi</th>
                    ...
                    <tbody class="divide-y-2 divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="py-4 pr-4 font-black uppercase tracking-tight text-lg">
                                {{ $category->name }}
                            </td>
